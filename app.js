...
mongoose.connect('mongodb://127.0.0.1:27017/yashEcomm')
.then(()=>{
...
//task-8 create route to see all the products in cart
...
app.post('/cart/add',async(req,res)=>{
    try{
        ...
        if(user.cart){
            ...
            productArray.array.forEach(async(productId) => {
